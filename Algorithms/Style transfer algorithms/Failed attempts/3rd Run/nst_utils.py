...
class CONFIG:
    ...
    VGG_MODEL = '/Users/adithyanarayanan/Documents/High School/Grade 10/Non Subject related/Personal Project/Code/imagenet-vgg-verydeep-19.mat'
    STYLE_IMAGE = 'images/stone_style.jpg'  # Style image to use.
    CONTENT_IMAGE = 'images/content300.jpg'  # Content image to use.
    OUTPUT_DIR = '/Users/adithyanarayanan/Documents/High School/Grade 10/Non Subject related/Personal Project/Code/output'
...
def load_vgg_model(path):
    ...
    graph['input'] = tf.Variable(
        np.zeros((1, CONFIG.IMAGE_HEIGHT, CONFIG.IMAGE_WIDTH, CONFIG.COLOR_CHANNELS)), dtype='float32')
