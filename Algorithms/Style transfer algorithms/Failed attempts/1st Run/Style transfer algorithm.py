...
def model_nn(sess, input_image, num_iterations=200):
    ...
    for i in range(num_iterations):
        ...
        save_image("/Users/adithyanarayanan/Documents/High School/Grade 10/Non Subject related/Personal Project/Code/output" +
                   str(i) + ".jpg", generated_image)

    save_image('/Users/adithyanarayanan/Documents/High School/Grade 10/Non Subject related/Personal Project/Code/output/generated_image.jpg', generated_image)
